$(function () {
                ...
                $.each(data, function(index, place) {
                    const html = ` <article>
                        ...
                        <div class="user">
                            ...
                            <div class="reviews">
                                <h2 class="article_subtitle">Reviews <span data-placeID="${place.id}" class="review-show">show</span></h2> 
                                <ul>
                                </ul>
                            </div>
                    </article>`
    ...
    // The show review functionality
    function showReview(parentEl) {
        const showReviews = $(parentEl).find("span.review-show")

        // show and hide reviews feature
        $(showReviews).each(function(index, el){
            $(el).on('click', function(e) {
                ...
                if ($(el).text() == "show")
                {
                    ...
                    $.get(endpoint, function(response, apiStatus) {
